...
const createToastFunction =
	(toastFunction: (message: string, options?: ExternalToast) => string | number) =>
...
const toastFunction = (message: string, options?: ExternalToast) =>
	createToastFunction(svToast)(message, options);
