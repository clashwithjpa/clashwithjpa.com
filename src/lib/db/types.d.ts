...
export interface CocAccounts {
  account_tag: string;
  discord_id: string;
  id: Generated<Int8>;
}

export interface CwlApplications {
  account_clan: string;
  account_name: string;
  account_tag: string;
...
export interface JoinApplications {
  account_tag: string;
  created_at: Timestamp;
  discord_id: string;
  discord_username: string;
...
export interface DB {
  ...
  bases: Bases;
  clans: Clans;
  coc_accounts: CocAccounts;
  cwl_applications: CwlApplications;
  cwl_clans: CwlClans;
  "extensions.pg_stat_statements": ExtensionsPgStatStatements;
  "extensions.pg_stat_statements_info": ExtensionsPgStatStatementsInfo;
  join_applications: JoinApplications;
