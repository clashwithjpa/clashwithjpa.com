 ...
 */
export const getCOCCWLWar200Schema = z.object({
 ...
 */
export const getCOCCWLWar500Schema = z.object({
    success: z.literal(false),
    error: z.union([z.string(), z.object({}).catchall(z.any())]),
});

export const getCOCCWLWarQueryResponseSchema = z.lazy(() => getCOCCWLWar200Schema);
