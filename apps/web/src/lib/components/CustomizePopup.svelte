<script lang="ts">
    ...
    // eslint-disable-next-line no-undef -- Keyframe and KeyframeAnimationOptions are DOM lib types
...
<Popup placement="left" title="Customize" maxWidth="max-w-64" contentClass="flex flex-col gap-6">
    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="relative">
            ...
            <div class="pointer-events-none absolute bottom-full left-1/2 flex h-28 w-16 -translate-x-1/2 items-end justify-center overflow-hidden">
                    ...
                    <svg width="64" height="76" viewBox="0 0 64 76" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {#if curse}
                            <g>
                                ...
                                <text x="53" y="10.5" text-anchor="middle" font-size="7.5" font-weight="700" fill="#dc2626" font-family="sans-serif"
                                    >#@$%!</text
                                >
                            </g>
                        {/if}
