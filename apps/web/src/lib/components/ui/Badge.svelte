<script lang="ts">
    ...
    let props: {
        ...
        content?: string;
        variant?: "blue" | "green" | "red" | "yellow" | "orange" | "purple" | "ghost" | "checkbox";
        size?: "base" | "button";
        checked?: boolean;
        class?: string;
        iconSize?: string;
    ...
    const colors = {
        ...
        orange: "border-orange-700/50 bg-orange-900 text-orange-200",
    ...
    const hoverColors = {
        ...
        orange: "hover:bg-orange-700 hover:text-orange-50",
