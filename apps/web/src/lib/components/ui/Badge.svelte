<script lang="ts">
    ...
    const colors = {
        blue: "border-blue-800/50 bg-blue-800/60 text-blue-200",
        green: "border-green-800/50 bg-green-800/60 text-green-200",
        red: "border-red-800/50 bg-red-800/60 text-red-200",
        yellow: "border-yellow-800/50 bg-yellow-800/60 text-yellow-200",
