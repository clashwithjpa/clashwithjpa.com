...
export const cocAccountTable = pgTable(
    "coc_account_table",
    {
        ...
        currentClan: text("current_clan"),
        townHall: integer("town_hall").notNull().default(0),
        totalDonated: integer("total_donated").notNull().default(0),
        totalReceived: integer("total_received").notNull().default(0),
        clanGames: integer("clan_games").notNull().default(0),
        capitalGoldLooted: integer("capital_gold_looted").notNull().default(0),
        capitalGoldContributed: integer("capital_gold_contributed").notNull().default(0),
...
export const clanApplicationStatusEnum = pgEnum("clan_application_status", ["pending", "accepted", "rejected"]);
