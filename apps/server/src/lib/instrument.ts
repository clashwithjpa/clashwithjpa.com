...
if (process.env.SENTRY_SPOTLIGHT === "true") {
    logger.info("Sentry Spotlight is enabled. Initializing Sentry...");
    ...
    logger.warn("Sentry Spotlight is disabled. Set SENTRY_SPOTLIGHT=true to enable it.");
}
